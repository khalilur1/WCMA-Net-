...
def preprocess_and_extract(dataset_dir, output_file):
    images, labels = [], []
    ...
    torch.save({"features": torch.tensor(images, dtype=torch.float32), "labels": torch.tensor(labels, dtype=torch.long)}, output_file)
...
if __name__ == "__main__":
    ...
    preprocess_and_extract(dataset_dir, output_file)
